...
require_once("../models/cambioDepEmpleado_model.php");
...
if(!isset($_SESSION["usuario"])){
		...
		if(isset($_POST["cambiar"])){
			if(!empty($_POST["empleado"]) && !empty($_POST["departamento"][0])){
				...
				$cambioDep=cambioDepa($idemp, $iddepa);
				$consultaemp=depaEmpleado($idemp);
			} else{
...
require_once("../views/cambioDepEmpleado_view.php");
